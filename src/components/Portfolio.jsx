  ...
  return (
    <Fragment>
      <div className="container">
        ...
        <div className="sm:ml-8 lg:ml-16 grid sm:grid-cols-2 gap-4">
          <div className="text-lg">
            <h1>Gofast</h1>
            <p className="my-2 font-semibold text-base sm:text-lg">USER EXPERIENCE. UI DESIGN, INTERFACE DESIGN</p>
            <img src={Gofast} alt="" />
          </div>
          <div className="text-lg">
            <h1>Quantum</h1>
