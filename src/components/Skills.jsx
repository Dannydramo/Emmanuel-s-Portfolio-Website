      ...
      <div className="container">
        <div className="flex flex-col-reverse sm:flex-row justify-between sm:ml-8 lg:ml-16 mt-20">
          ...
          <div className="w-full sm:w-1/2 lg:w-[55%]">
            <p className="mb-8 text-lg lg:text-xl"> Hi there, I am Emmanuel Amaechi. </p>

            <p className="text-lg lg:text-xl lg:leading-[34px]">
            ...
            <p className="mt-8 text-lg lg:text-xl lg:leading-[34px]">
